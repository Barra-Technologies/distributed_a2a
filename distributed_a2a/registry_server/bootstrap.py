...
def load_registry(agent_registry: AgentRegistryLookup, mcp_registry: McpRegistryLookup) -> FastAPI:
    ...
    @agent_router.put("/agent-card/{name}") # type: ignore[untyped-decorator]
    ...
    @agent_router.get("/agent-card/{name}") # type: ignore[untyped-decorator]
    ...
    @agent_router.get("/agent-cards") # type: ignore[untyped-decorator]
    def get_agent_cards() -> list[dict[str, Any]]:
        """Endpoint to retrieve all agent cards."""
        return agent_registry.get_agent_cards()

    @agent_router.patch("/agent-card/{name}/heartbeat") # type: ignore[untyped-decorator]
    ...
    @mcp_router.put("/mcp/server") # type: ignore[untyped-decorator]
    ...
    @mcp_router.get("/mcp/server/{name}") # type: ignore[untyped-decorator]
    ...
    @mcp_router.get("/mcp/servers") # type: ignore[untyped-decorator]
    def get_mcp_servers() -> list[McpServer]:
        """Endpoint to retrieve all MCP servers."""
        return mcp_registry.get_mcp_servers()

    @mcp_router.put("/mcp/{name}/agent/{agent_name}") # type: ignore[untyped-decorator]
    ...
    @mcp_router.delete("/mcp/{name}/agent/{agent_name}") # type: ignore[untyped-decorator]
    ...
    @mcp_router.get("/mcp/{name}/agent") # type: ignore[untyped-decorator]
    ...
    @mcp_router.get("/mcp/agent/{agent_name}/servers") # type: ignore[untyped-decorator]
